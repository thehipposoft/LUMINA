        ...
        <section id="luminalab" className="relative py-20 bg-gradient-to-br from-[#35E3ED]/10 via-[#007BFF]/10 to-[#A044FF]/10 overflow-hidden">
          ...
          <div className="relative z-10 text-center px-6">
            <div className="max-w-2xl mx-auto">
              <p className="text-lg text-[#151f25]/70 mb-4">We reimagine the interface between light and matter</p>
              <h2 className="text-5xl font-bold text-[#151f25] mb-8">LuminaLAB.</h2>
