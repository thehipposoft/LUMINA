...
const LabPageComponent = () => {
  ...
  return (
    <div ref={containerRef} className='flex flex-col'>
        ...
        <section className='section-two flex lg:flex-row flex-col-reverse gap-12 lg:gap-0 justify-between w-[85vw] lg:max-w-7xl mx-auto lg:py-24 py-12'>
            <div className='lg:w-1/2'>
                <Image
        ...
        <section className='section-four flex lg:flex-row flex-col-reverse gap-12 lg:gap-0 justify-between w-[85vw] lg:max-w-7xl mx-auto lg:py-24 py-12'>
            <div className='lg:w-1/2'>
                <Image
        ...
        <section className='section-five flex lg:flex-row flex-col gap-12 lg:gap-0 justify-between w-[85vw] lg:max-w-7xl mx-auto lg:py-24 py-12'>
            <div className='lg:w-[520px] flex flex-col gap-6 lg:pt-8'>
                <div className='flex gap-6 items-center'>
                    <Image src={'/images/lab/vector.svg'} alt="Lumina Arrow" width={25} height={20} className="object-contain" />
