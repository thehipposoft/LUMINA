...
const COLORS = {
    // Main OLED colors
    DEFAULT_OLED: 0xA044FF,    // 👈 Default OLED blue color
    HOVER_OLED: 0x007BFF,      // 👈 Hover/active OLED cyan color

    // Glow effect colors
    GLOW_COLOR: 0x007BFF,      // 👈 Glow/shadow effect color
        ...
        <group>
            ...
            >
                ...
                <meshPhysicalMaterial
                    ...
                    emissiveIntensity={1}                        // 👈 Default glow intensity: 0.3

                    // 🔍 TRANSPARENCY SETTINGS - Layer 1: Less glassy baseline
                    transparent={true}
                    opacity={1}                                  // 👈 Less transparent baseline: 0.6 (more solid)

                    // ✨ GLASS EFFECT PROPERTIES - Layer 1: Reduced glass effect
                    roughness={1}                                // 👈 Surface roughness: 0.1 = very smooth/glossy
                    metalness={0.0}                                // 👈 Metallic properties: 0.0 = non-metallic
                    transmission={0.1}                             // 👈 Reduced light transmission: 0.4 = less glassy
                    thickness={0.9}                                // 👈 Increased glass thickness for refraction
    ...
    useFrame((state) => {
        if (meshRef.current) {
            ...
            if (meshRef.current.material) {
                ...
                material.opacity = THREE.MathUtils.lerp(0.2, 0.1, t)          // 👈 Transparency: 0.2 (glass) → 0.75 (opaque)
    ...
    return (
        ...
        >
            ...
            >
                ...
                {/* Three OLED layers separated in depth. Ordered from back (bottom) to front (top) */}
                <OLEDLayer1 />
                <OLEDLayer2 />
                <OLEDLayer3 />
