      ...
      <div className="max-w-7xl mx-auto px-6 py-4">
        <nav className="flex items-center justify-between">
          <Link href="/" className="flex items-center space-x-2 nav-item">
            ...
            <span className="text-xl font-bold text-[#151f25]">LUMINA</span>
            <span className="text-sm text-[#151f25]/70">TECHNOLOGIES</span>
          </Link>
          ...
          {/* Mobile menu button */}
          <button className="md:hidden nav-item text-[#151f25] hover:text-[#007BFF]">
